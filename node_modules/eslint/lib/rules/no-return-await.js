  ...
  create(context) {
        ...
        suggest: [
          {
            ...
            fix(fixer) {
              ...
              const [awaitToken, tokenAfterAwait] = sourceCode.getFirstTokens(
                node,
                2,
              );

              const areAwaitAndAwaitedExpressionOnTheSameLine =
                awaitToken.loc.start.line === tokenAfterAwait.loc.start.line;
    ...
    function isInTailCallPosition(node) {
      ...
      if (
        ...
        (node === node.parent.consequent || node === node.parent.alternate)
      ) {
