    ...
    function prepareCheck(node, body, name, opts) {
      ...
      if (hasBlock && (body.body.length !== 1 || areBracesNecessary(body))) {
        ...
        if (hasBlock) {
          ...
          expected =
            !isOneLiner(statement) || leadingCommentsInBlock.length > 0;
        } else {
              ...
              context.report({
                ...
                fix(fixer) {
                  ...
                  const needsPrecedingSpace =
                    ...
                    sourceCode.getTokenBefore(body).range[1] ===
                      body.range[0] &&
                    !astUtils.canTokensBeAdjacent(
                      'do',
                      sourceCode.getFirstToken(body, { skip: 1 }),
                    );

                  const openingBracket = sourceCode.getFirstToken(body);
                  const closingBracket = sourceCode.getLastToken(body);
                  const lastTokenInBlock =
                    sourceCode.getTokenBefore(closingBracket);
