...
module.exports = {
  ...
  create(context) {
    ...
    function checkPadding(node) {
      ...
      const tokenBeforeFirst = sourceCode.getTokenBefore(firstBlockToken, {
        includeComments: true,
      });
      const closeBrace = sourceCode.getLastToken(node);
      const lastBlockToken = getLastBlockToken(closeBrace);
      const tokenAfterLast = sourceCode.getTokenAfter(lastBlockToken, {
        includeComments: true,
      });
      const blockHasTopPadding = isPaddingBetweenTokens(
        tokenBeforeFirst,
        firstBlockToken,
      );
      const blockHasBottomPadding = isPaddingBetweenTokens(
        lastBlockToken,
        tokenAfterLast,
      );
