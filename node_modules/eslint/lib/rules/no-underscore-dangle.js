...
module.exports = {
  ...
  create(context) {
    ...
    const allowAfterThis =
      typeof options.allowAfterThis !== 'undefined'
        ? options.allowAfterThis
        : false;
    const allowAfterSuper =
      typeof options.allowAfterSuper !== 'undefined'
        ? options.allowAfterSuper
        : false;
    const allowAfterThisConstructor =
      typeof options.allowAfterThisConstructor !== 'undefined'
        ? options.allowAfterThisConstructor
        : false;
    const enforceInMethodNames =
      typeof options.enforceInMethodNames !== 'undefined'
        ? options.enforceInMethodNames
        : false;
    const enforceInClassFields =
      typeof options.enforceInClassFields !== 'undefined'
        ? options.enforceInClassFields
        : false;
    const allowFunctionParams =
      typeof options.allowFunctionParams !== 'undefined'
        ? options.allowFunctionParams
        : true;
    const allowInArrayDestructuring =
      typeof options.allowInArrayDestructuring !== 'undefined'
        ? options.allowInArrayDestructuring
        : true;
    const allowInObjectDestructuring =
      typeof options.allowInObjectDestructuring !== 'undefined'
