...
module.exports = {
  ...
  create(context) {
    ...
    function hasBlankLineAfterComment(token, commentStartLine) {
      return (
        token.loc.start.line > getLastCommentLineOfBlock(commentStartLine) + 1
      );
    }
    ...
    function checkForBlankLine(node) {
      ...
      const nextLineNum = lastToken.loc.end.line + 1;
          ...
          fix(fixer) {
            if (
              (noNextLineToken
                ...
                : lastToken.loc.end.line) === nextToken.loc.start.line
            ) {
