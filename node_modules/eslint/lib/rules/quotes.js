      ...
      Literal(node) {
        ...
        if (settings && typeof val === 'string') {
          ...
          if (!isValid && avoidEscape) {
            isValid =
              astUtils.isSurroundedBy(rawVal, settings.alternateQuote) &&
