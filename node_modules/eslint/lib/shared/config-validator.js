...
const {
  Legacy: { ConfigOps, environments: BuiltInEnvironments },
} = require('@eslint/eslintrc');
const configSchema = require('../../conf/config-schema');
const BuiltInRules = require('../rules');
const { emitDeprecationWarning } = require('./deprecation-warnings');
