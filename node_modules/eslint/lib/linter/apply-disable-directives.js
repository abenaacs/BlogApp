...
function createIndividualDirectivesRemoval(directives, commentToken) {
  ...
  return directives.map((directive) => {
    ...
    let removalStartOffset;
    let removalEndOffset;
...
function applyDirectives(options) {
    ...
    if (disableDirectivesForProblem.length > 0) {
      ...
      if (problem.suppressions) {
        ...
        usedDisableDirectives.add(
          disableDirectivesForProblem[disableDirectivesForProblem.length - 1],
        );
      }
    }
  ...
  const unusedEnableDirectivesToReport = new Set(
    options.directives.filter(
      (directive) => directive.unprocessedDirective.type === 'enable',
    ),
  );
      ...
      return {
        ...
        line:
          type === 'disable-next-line'
            ? parentComment.commentToken.loc.start.line
            : line,
        column:
          type === 'disable-next-line'
            ? parentComment.commentToken.loc.start.column + 1
            : column,
