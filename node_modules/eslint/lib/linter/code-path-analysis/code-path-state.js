...
class CodePathState {
  ...
  popChoiceContext() {
    ...
    const { forkContext } = this;
    const { head } = forkContext;
  ...
  popSwitchContext() {
    ...
    const { forkContext } = this;
    const { brokenForkContext } = this.popBreakContext();
  ...
  popLoopContext() {
    ...
    switch (context.type) {
      ...
      case 'DoWhileStatement': {
         ...
         * top of the loop.
         */
        const { segmentsList } = choiceContext.trueForkContext;
  ...
  popBreakContext() {
    ...
    if (!context.breakable) {
      const { brokenForkContext } = context;
